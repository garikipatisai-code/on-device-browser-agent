...
- When comparing several things, use the SAME measure for every one of them. For a CITY's population, use each city's own city-proper figure (the headline number on its page, e.g. Austin "961,855") — do NOT compare one city's metro-area figure to another's city figure. Only use metro-area numbers if the goal explicitly asks for the metro area, and then use metro for all of them.
